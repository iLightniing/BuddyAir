...
<template>
  <UiModal :show="show">
    <div class="bg-ui-surface border border-ui-border p-6 rounded-md shadow-2xl max-w-md w-full">
      ...
      <p class="text-sm text-ui-content-muted mb-6">Êtes-vous sûr de vouloir supprimer cette échéance de <span class="font-bold text-ui-content">{{ item?.amount }} €</span> ?</p>
